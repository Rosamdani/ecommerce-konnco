    ...
    <div class="flex w-full mx-auto min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form class="space-y-6" wire:submit.prevent="save">
                <div>
                    ...
                    <div class="mt-2">
                        <input id="email" wire:model="email" type="email"
                            class="block {{ $errors->has('email') ? 'border border-red-500' : 'border-0'}} w-full px-3 rounded-md py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                    @error('email')
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input id="nama" wire:model="nama" type="text"
                            class="block {{ $errors->has('nama') ? 'border border-red-500' : 'border-0'}} w-full px-3 rounded-md py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                    @error('nama')
                    <div class="text-xs text-red-500">{{ $message }}</div>
                    @enderror
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input id="password" wire:model="password" type="password"
                            class="block {{ $errors->has('password') ? 'border border-red-500' : 'border-0'}} w-full px-3 rounded-md py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                    @error('password')
                    <div class="text-xs text-red-500">{{ $message }}</div>
                    @enderror
                ...
                <div>
                    <div class="flex items-center justify-between">
                        <label for="re-password" class="block text-sm font-medium leading-6 text-gray-900">Konfirmasi
                            password</label>
                    </div>
                    <div class="mt-2">
                        <input id="re-password" wire:model="re_password" type="password"
                            class="block {{ $errors->has('re_password') ? 'border border-red-500' : 'border-0'}} w-full px-3 rounded-md py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                    @error('re_password')
                    <div class="text-xs text-red-500">{{ $message }}</div>
                    @enderror
                ...
                <div>
                    <button type="submit"
                        class="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"><span
                            wire:loading.remove>Daftar sekarang</span> <span wire:loading>Proses...</span></button>
                </div>
            </form>
